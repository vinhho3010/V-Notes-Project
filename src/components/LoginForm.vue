  ...
  <section class="h-screen">
    <div class="px-6 h-[90%]">
      <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
        <div class="md:w-4/12 lg:w-4/12">
          <form>
            <div class="font-semibold text-2xl py-4">Đăng nhập</div>
            <!-- Email input -->
            <div class="mb-6">
              <input type="text"
            ...
            <div class="flex justify-between items-center mb-6">
              <div class="form-group form-check">
                ...
                <label class="form-check-label inline-block text-gray-800" for="exampleCheck2">Nhớ tài khoản</label>
              </div>
              <a href="#!"
